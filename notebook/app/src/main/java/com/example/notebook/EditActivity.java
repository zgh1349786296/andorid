...
import com.example.notebook.util.DateFormatType;
import com.example.notebook.util.MyFormat;
import com.example.notebook.util.MyTimeGetter;

import java.util.Date;

import static com.example.notebook.util.MyFormat.getTimeStr;
import static com.example.notebook.util.MyFormat.myDateFormat;
...
public class EditActivity extends BaseActivity implements View.OnClickListener,  //新建activity
     ...
     */
    void intentStart(){
        Intent intent = new Intent(EditActivity.this,MainActivity.class);  //跳转主界面
     ...
     * 备忘录保存函数
     */
    boolean saveFunction(String title,String body,String createDate){ //保存判定
        ...
        if(flag){
            ...
            String authors = sp.getString("author","张广浩");
            SQLiteDatabase db;
            ...
            db.insert(MyDB.TABLE_NAME_RECORD,null,values);  //存入数据库
     ...
     * @param createDate
     */
    void showDialog(final String title, final String body, final String createDate){  //点击返回时提示弹框
        ...
        dialog.setPositiveButton("保存",
            ...
            public void onClick(DialogInterface dialog, int which) {
                saveFunction(title, body, createDate);  //保存参数
                intentStart();  //跳转
                    }
                });
